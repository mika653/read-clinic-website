          ...
          {[
            ...
            },
            {
              ...
              features: [
                ...
                "<strong>SaligPay payments</strong> (no monthly fee &mdash; per-transaction fees deducted from settlement, e.g. ₱50 on a ₱2,000 GCash payment)",
        ...
        <div className="mt-6 rounded-2xl border border-gray-100 p-6 sm:p-7">
          ...
          <div className="space-y-3">
            {[
              ...
              {
                service: "SaligPay per-transaction fees",
                cost: "Deducted from each payment",
                detail: "No signup or monthly fee from SaligPay. Per-transaction fees are deducted from settlement &mdash; e.g. on a ₱2,000 GCash payment, ₱50 (2.5%) is deducted and R.E.A.D. receives ₱1,950. Same model as PayMongo, Xendit, etc. Integration is included in your tier.",
                tier: "Centre Plus & Full Suite",
                tierColor: "#C9A84C",
              },
              {
